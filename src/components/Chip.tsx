...
export const Chip = ({ name, isSelected, handleOnClick }: Props) => {
  return (
    <div
      className={`inline-block align-middle ${ isSelected === true ? "bg-yellow-500" : "bg-gray-800"} text-white text-sm leading-4 px-4 py-2 cursor-pointer rounded-full mr-1 mb-1`}
